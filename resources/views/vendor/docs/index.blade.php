...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <h1>
        Buzzy Documentation
        <small>Current version {{ config('buzzy.version') }}</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="content body">
      ...
      <section id="changelog">
        ...
        <li>New support center opened on http://support.akbilisim.com. Docs can be found http://support.akbilisim.com/help-center</li>
        </ul>
        ...
        <h4>V2.5 – <em>08/06/17</em></h4>
          ...
          - Google Amp support http://buzzy.akbilisim.com/amp/<br>
          - Two new theme style – http://buzzyviralmag.akbilisim.com/ http://buzzyboxed.akbilisim.com/<br>
          - Facebook Instant article support – http://buzzy.akbilisim.com/fbinstant.rss<br>
